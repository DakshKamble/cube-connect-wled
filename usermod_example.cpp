...
class CubeConnectUsermod : public Usermod {
  ...
  public:
    ...
    //   CubeConnectUsermod* um = (CubeConnectUsermod*) UsermodManager::lookup(USERMOD_ID_MYUSERMOD);
...
const char CubeConnectUsermod::_name[]    PROGMEM = "ExampleUsermod";
const char CubeConnectUsermod::_enabled[] PROGMEM = "enabled";


// implementation of non-inline member methods

void CubeConnectUsermod::publishMqtt(const char* state, bool retain)
{
#ifndef WLED_DISABLE_MQTT
...
static CubeConnectUsermod example_usermod;
